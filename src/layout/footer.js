...
const Footer = () => {
  ...
  return (
        ...
        <div className="row gy-2 gy-lg-0 justify-content-xl-between">
          <div className="col-12 col-md-4 col-lg-3 col-xl-2">
            <div className="widget">
              <Link href="/">
                <Image src={logo} alt="Discovery Connect Logo" width="100" height="100" />
              </Link>
            </div>
          </div>
          <div className="col-12 col-md-4 col-lg-3 col-xl-2">
            <div className="widget">
              <h4 className="widget-title mb-3 fs-6">Get in Touch</h4>
          ...
          <div className="col-12 col-md-4 col-lg-3 col-xl-2">
            <div className="widget">
              <h4 className="widget-title mb-3 fs-6">Learn More</h4>
          ...
          <div className="col-12 col-lg-3 col-xl-4">
            <div className="widget">
              <h4 className="widget-title mb-3 fs-6">Our Newsletter</h4>
              <p className="mb-3 fs-sm">
    ...
    <div className="bg-light py-2">
      <div className="container overflow-hidden">
        <div className="row gy-2 gy-md-0 align-items-md-center">
          <div className="col-xs-12 col-md-7 order-1 order-md-0">
            <div className="copyright text-center text-md-start fs-sm">
