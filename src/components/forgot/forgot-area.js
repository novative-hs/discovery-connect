...
// import ForgotImage from "@assets/img/slider/13/forgot1.jpg.png"; // apna image path

// const ForgotArea = () => {
//   return (
//     <section className="forgot-area position-relative py-110">
//       {/* Content */}
//       <div className="container">
//         <div className="row justify-content-center">
//           {/* Brand Header */}
//           {/* <div className="col-12 text-center mb-4">
//             <h2 className="fw-bold text-primary">Debugsol Software Solutions</h2>
//           </div> */}
...
//                       <h4 className="fw-bold mb-2">A few more clicks to sign in to your account.</h4>
//                       <h5 className="fw-bold text-dark mb-3">Forget password?</h5>
//                     </div>
...
import Image from "next/image";
import ForgotForm from "@components/forms/forgot-form";
import ForgotImage from "@assets/img/slider/13/girl.jpg"; // apna image path
