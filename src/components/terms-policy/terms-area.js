          ...
          <div className="col-xl-10 col-lg-11">
            ...
            >
              <p className="text-start mb-0 fs-5">
                <strong className="d-block mb-2 fs-4">
              ...
              <p className="text-start mb-0 mt-3 fs-5">
...
//       className="policy__area py-5"
//       style={{
//         backgroundImage: "url('/assets/img/about/good.jpg')",
...
//               {/* Informed Consent */}
//               <div className="mb-4">
//                 <h4 className="fw-bold text-primary">Informed Consent</h4>
...
//               {/* Collection & Use */}
//               <div className="mb-4">
//                 <h4 className="fw-bold text-success">Collection, Storage, and Use of Samples</h4>
//                 <ul className="text-start ps-3">
...
//               {/* Privacy */}
//               <div className="mb-4">
//                 <h4 className="fw-bold text-danger">Privacy and Data Protection</h4>
//                 <ul className="text-start ps-3">
...
//               {/* Intellectual Property */}
//               <div className="mb-4">
//                 <h4 className="fw-bold text-info">Intellectual Property</h4>
//                 <ul className="text-start ps-3">
...
//               {/* Liability */}
//               <div className="mb-4">
//                 <h4 className="fw-bold text-warning">Limitations of Liability</h4>
//                 <ul className="text-start ps-3">
...
//               {/* Changes */}
//               <div className="mb-3">
//                 <h4 className="fw-bold text-secondary">Changes to the Terms</h4>
//                 <ul className="text-start ps-3">
