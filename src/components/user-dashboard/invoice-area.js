                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className="text-end pe-3"> {/* Right-aligned with padding */}
                        {item.SamplePriceCurrency} {price.toLocaleString()}
                      </td>
                      <td className="text-end pe-3"> {/* Right-aligned with padding */}
                        {item.SamplePriceCurrency} {subTotal.toLocaleString()}
                      </td>
                    </tr>
                  );
                })}
                ...
                <tr className="total-row">
                  ...
                  <td className="text-end fw-bold" style={{ paddingRight: '16px' }}>
                    {(function () {
                      ...
                      const currency = cart_products[0]?.currency || 'PKR'; // default to PKR
