...
const TestResultUnitArea = () => {
  ...
  const [selectedTestResultUnitnameId, setSelectedTestResultUnitnameId] =useState(null); // Store ID of Plasma to delete
  const [formData, setFormData] = useState({
    testresultunitname: "",
    added_by: id,
  });
  const [editTestResultUnitname, setEditTestResultUnitname] =
  ...
  const totalPages = Math.ceil(testResultUnitname.length / itemsPerPage);
  // Api Path
  ...
  const fetchTestResultUnitname = async () => {
    try {
      const response = await axios.get(
        `${url}/testresultunit/get-testresultunit`
      );
  ...
  const currentData = testResultUnitname.slice(
  ...
  const handleFilterChange = (field, value) => {
    if (value === "") {
      fetchTestResultUnitname(); // Reset to fetch original data
    } else {
      // Filter the sample array based on the field and value
      const filtered = testResultUnitname.filter((testmethod) =>
        testResultUnitname[field]
          ?.toString()
          .toLowerCase()
          .includes(value.toLowerCase())
      );
      setTestResultUnitname(filtered); // Update the state with filtered results
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${url}/testresultunit/post-testresultunit`,
        formData
      );
  ...
  const handleDelete = async () => {
    try {
      ...
      await axios.delete(
        `${url}/testresultunit/delete-testresultunit/${selectedTestResultUnitnameId}`
      );
      console.log(
  ...
  const handleEditClick = (testResultUnitname) => {
    ...
    setFormData({
      testresultunitname: testResultUnitname.name,
      added_by: id,
    });
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${url}/testresultunit/put-testresultUnit/${selectedTestResultUnitnameId}`,
        formData
      );
      console.log(
        "Test ResultUnit Name updated successfully:",
        response.data
      );
                  ...
                  <thead className="thead-dark">
                    <tr className="text-center">
                      {[
                        ...
                        {
                          label: "Test Result Unit Name",
                          placeholder: "Search Test Result Unit Name",
                          field: "name",
                        },
                        {
                          label: "Added By",
                          ...
                          <div className="modal-body">
                            ...
                            <div className="form-group">
                              ...
                              <input
                                ...
                                name="testresultunitname" // Fix here
                                value={formData.testresultunitname}
                  ...
                  >
                    <div className="modal-dialog" role="document">
                      <div className="modal-content">
                        ...
                        <div className="modal-body">
                          <p>
                            Are you sure you want to delete this Test Result Unit?
                          </p>
                        </div>
                        <div className="modal-footer">
                          <button
